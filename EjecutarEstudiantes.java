...
public class EjecutarEstudiantes {
    public static void main(String[] args) {
        ...
        String f = "Ingeniería";
        System.out.println("# de estudiantes: " + Estudiantes.contarEstudiantes(est, f) + " : " + f);

        //Ejecución del método listarEstudiantes
        System.out.println("Listado de estudiantes en " + f + ":");
        for(Estudiantes e : Estudiantes.listarEstudiantes(est, f)){
